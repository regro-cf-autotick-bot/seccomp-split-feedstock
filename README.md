...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/seccomp-split-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/seccomp-split-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libseccomp seccomp
# for installing globally
pixi global install libseccomp seccomp
```
...
It is possible to list all of the versions of `libseccomp` available on your platform:
...
```
pixi search libseccomp --channel conda-forge
```
